"""Kiran agent entry point with isolated read-only subagents."""
...
from llm.llm_with_subagents_8 import SYSTEM_PROMPT, call_llm
from tools.tools_with_subagents_5 import TOOL_SCHEMAS, execute
